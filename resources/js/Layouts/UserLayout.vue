...
import LogoExperientya from "@/CustomComponents/ExperientyaLogo";
import UserHeader from "@/CustomComponents/UserHeader";
import JetBanner from "@/Jetstream/Banner.vue";
import JetDropdown from "@/Jetstream/Dropdown.vue";
import JetDropdownLink from "@/Jetstream/DropdownLink.vue";
import JetNavLink from "@/CustomComponents/NavLink.vue";
          ...
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
              <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                  <Link :href="route('dashboard')">
                    ...
                    />
                    <img
                      class="hidden lg:block h-32 w-auto"
                      src="../../img/logo-01.png"
                      alt="Workflow"
                    />
                  </Link>
              ...
              <div class="flex">
                ...
                >
                  <JetDropdown align="right" width="48" class="hidden">
                    <template #trigger>
                      <button
                        ...
                        :class="{
                          'text-base h-8 relative items-center px-4 py-2 border border-transparent font-medium rounded-full text-white bg-blue-500 shadow-sm hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500':
                            route().current(
                              'user.vacancies',
                              'user.appliedvacants'
                            ),
                    ...
                    <template #content>
                      <div
                        class="block px-4 py-2 text-xs text-gray-400 select-none"
                      >
                        Menú de Vacantes
                      </div>
                  ...
                  <JetNavLink
                    :href="route('user.micv')"
                    :active="route().current('user.micv')"
                  >
                    MI CV
                  </JetNavLink>
                  <JetNavLink
                      ...
                      <template #trigger>
                        ...
                        >
                          <img
                            ...
                            :src="
                              '/' +
                              $page.props.user.profile_photo_path.replace(
                                'profile/',
                                'storage/profile/'
                              )
                            "
