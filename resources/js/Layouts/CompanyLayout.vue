    ...
    <div class="min-h-full">
        ...
        <div class="hidden lg:flex lg:w-64 lg:fixed lg:inset-y-0">
            ...
            <nav class="px-3 mt-6">
                ...
                <Link :href="route('company.index')" class="bg-gray-900 text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md" aria-current="page">
                    <!--
                    Heroicon name: outline/home
                ...
                <Link :href="route('offer.index')" class="text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                    <!-- Heroicon name: outline/view-list -->
