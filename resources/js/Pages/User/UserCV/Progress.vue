<template>
   ...
   <aside id="progress" class="max-w-72 min-h-screen h-full max-h-[200vh] flex flex-col flex-grow z-20 left-0"
      aria-label="Sidebar">
      <div
         class="w-auto py-2 lg:py-4 h-full max-h-[170vh] lg:max-h-[200vh] px-4 lg:px-2 min-h-screen bg-gray-100 rounded lg:w-auto 2xl:w-64">
         <!-- PROGRESS CIRCLE  -->
         <div class="space-y-2">
            ...
            <div
               ...
               <span class="relative text-base lg:text-lg font-extrabold text-gray-900">{{ this.general_progress
               }}%</span>
            </div>
         </div>
         <ul class="pt-3 mt-3 space-y-2 border-t border-gray-800">
            <li>
               <div
                  class="p-0.5 lg:p-1.5 text-base font-semibold text-white rounded-lg transition duration-75 group bg-blue-500">
                  <a href="#workPreferencesSection">
