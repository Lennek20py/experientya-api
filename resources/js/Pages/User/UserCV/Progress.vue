<template>
   ...
   <aside id="progress" class="max-w-72 min-h-screen h-full max-h-[200vh] flex flex-col flex-grow z-20 left-0" aria-label="Sidebar">
      <div class="w-auto py-2 lg:py-4 h-full max-h-[170vh] lg:max-h-[200vh] px-4 lg:px-2 min-h-screen bg-gray-100 rounded lg:w-auto 2xl:w-64">
         <!-- PROGRESS CIRCLE  -->
         <div class="space-y-2">
            <h2 class="text-center text-gray-900 font-extrabold text-2xl "> Perfil </h2>
            <div
               class="circular-progress mx-auto relative h-32 w-32 lg:h-36 lg:w-36 flex items-center justify-center before:absolute before:h-20 before:w-20">
               <span class="relative text-base lg:text-lg font-extrabold text-gray-900">{{ this.general_progress }}%</span>
            </div>
         </div>
         <ul class="pt-3 mt-3 space-y-2 border-t border-gray-800">
            <li>
               <div class="p-0.5 lg:p-1.5 text-base font-semibold text-white rounded-lg transition duration-75 group bg-blue-500">
            ...
            <li>
               <div
                  class="p-0.5 lg:p-1.5 text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-blue-500 hover:text-white hover:cursor-pointer" @click="scrollToMe()">
...
export default ({
   ...
   methods: {
      ...
      calculate() {
         ...
         this.progress["testsoftskill"] == 30 ? subtotal += 1 : subtotal = subtotal
