        ...
        <main class="bg-gray-100 py-12">
            ...
            <Transition>
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" v-if="bind">
                    <div
                        class="mt-24 mb-16 flex min-h-full rounded-2xl bg-white shadow-md"
                    >
                        <div
                            class="flex flex-1 flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-20"
                        >
                            <div class="mx-auto w-full lg:w-[31rem]">
                                ...
                                <div class="mt-8">
                                    <div>
                                        <label
                                            class="mx-auto text-gray-400 text-sm"
                                            ><span
                                                class="block after:ml-0.5 after:text-red-500 after:content-['*']"
                                                >Es fácil y rápido. Los campos
                                                requeridos son marcados con un
                                                asterisco</span
                                            ></label
                                        >
                                    ...
                                    <div class="mt-6">
                                        ...
                                        >
                                            ...
                                            >
                                                <div
                                                    class="mb-6 w-full px-3 md:mb-0 md:w-1/2"
                                                >
                                                    <label
                                                        class="mb-2 block"
                                                        for="first_name"
                                            ...
                                            <div class="space-y-1">
                                                ...
                                                >
                                                    <span
                                                        class="block text-sm font-medium text-slate-700 after:ml-0.5"
                                                        >Foto de perfil</span
                                                    >
                                                </label>
                                                <div
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <span
                                                        ...
                                                        >Acepto recibir
                                                        comunicados de mi
                                                        interés relacionados con
                                                        EXPERIENTYA.</span
                                                    >
                                                </label>
                                                <jet-input-error
                                                    :message="
                                                        user.errors.newsletter
                                                    "
                                                />
                                            </div>
                                            <div>
                                                <jet-button
                                                    ...
                                                    >Guardar y
                                                    Continuar</jet-button
                                                >
                                            </div>
                                            <jet-input-error
                                                :message="
                                                    user.errors.confirmation
                                                "
                                            />
                                        </form>
                                    </div>
                        ...
                        <div class="relative hidden w-0 flex-1 lg:block">
                            <img
                                class="absolute inset-0 h-full w-full rounded-r-2xl object-cover"
                    ...
                    >
                        ...
                        >
                            <div class="mx-auto w-full lg:w-[35rem]">
                                ...
                                <div class="mt-6">
                                    <label class="mx-auto text-gray-400 text-sm"
                                        ><span
                                            class="block after:ml-0.5 after:text-red-500 after:content-['*']"
                                            >Para finalizar su registro ingrese
                                            su datos de contacto. Los campos
                                            requeridos son marcados con un
                                            asterisco</span
                                        ></label
                                    >
                                    ...
                                    <div class="mt-6">
                                        ...
                                        >
                                            <div
                                                class="-mx-3 mb-2 flex flex-wrap"
                                            >
                                                <div
                                            ...
                                            <div
                                                class="flex content-around justify-around"
                                            >
                                                <button
                                                    type="button"
                                                ...
                                                <jet-button
                                                    :disabled="user.processing"
                                                    class="flex w-1/2 justify-center rounded-md border border-transparent bg-blue-500 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                                                    >Guardar y
                                                    Continuar</jet-button
                                                >
                                            </div>
                        ...
                        <div class="relative hidden w-0 flex-1 lg:block">
                            <img
                                class="absolute inset-0 h-full w-full rounded-r-2xl object-cover"
                                src="https://pbs.twimg.com/media/EYid9iWWsAAaMGX?format=jpg&name=4096x4096"
                                alt
                            />
                        </div>
                    </div>
