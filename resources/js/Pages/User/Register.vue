                    ...
                    <div class="mt-24 mb-16 flex min-h-full rounded-2xl bg-white shadow-md">
                        <div class="flex flex-1 flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-20">
                            <div class="mx-auto w-full lg:w-[31rem]">
                                ...
                                <div class="mt-8">
                                    <div>
                                        <label class="mx-auto text-gray-400 text-sm"><span
                                                class="block after:ml-0.5 after:text-red-500 after:content-['*']">Es fácil y
                                                rápido. Los campos requeridos son marcados con un asterisco</span></label>
                                        ...
                                        <form @submit.prevent="validateFirstStep" class="space-y-6">
                                            <div class="-mx-3 mb-6 flex flex-wrap">
                                                <div class="mb-6 w-full px-3 md:mb-0 md:w-1/2">
                                                    <label class="mb-2 block" for="first_name">
                                                        <span
                                                            class="block text-sm font-medium text-slate-700 after:ml-0.5 after:text-red-500 after:content-['*']">Nombre(s)</span>
                                                    </label>
                                                    <div class="mt-1">
                                                ...
                                                <div class="w-full px-3 md:w-1/2">
                                                    <label class="mb-2 block" for="last_name">
                                                        <span
                                                            class="block text-sm font-medium text-slate-700 after:ml-0.5 after:text-red-500 after:content-['*']">Apellidos</span>
                                                    </label>
                                                    <div class="mt-1">
                                            ...
                                            <div>
                                                <label for="CURP" class="block text-sm font-medium text-gray-700">
                                                    <span
                                                        class="block text-sm font-medium text-slate-700 after:ml-0.5 after:text-red-500 after:content-['*']">CURP</span>
                                                </label>
                                                <div class="mt-1">
                                                    <input id="CURP" name="CURP" type="text" minlength="18" maxlength="18"
                                                        autocomplete="CURP" required :value="user.CURP.toUpperCase()"
                                            ...
                                            <div>
                                                <label for="email" class="block text-sm font-medium text-gray-700">
                                                    <span
                                                        class="block text-sm font-medium text-slate-700 after:ml-0.5 after:text-red-500 after:content-['*']">Email</span>
                                                </label>
                                                <div class="mt-1">
                                            ...
                                            <div class="space-y-1">
                                                <label for="password" class="block text-sm font-medium text-gray-700">
                                                    <span
                                                        class="block text-sm font-medium text-slate-700 after:ml-0.5 after:text-red-500 after:content-['*']">Contraseña</span>
                                                </label>
                                                <div
                                                    class="flex flex-nowrap justify-center align-middle mt-1 border-2 rounded-md">
                                                    <input v-if="!showPass" id="password" name="password" type="password"
                                                        minlength="6" @blur="validatePassword"
                                                        autocomplete="current-password" required
                                                        class="block w-full appearance-none border-none px-3 py-2 placeholder-gray-400 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500 sm:text-sm"
                                                        v-model="user.password" />
                                                    <input v-else id="password" name="password" type="text" minlength="6"
                                                        @blur="validatePassword" autocomplete="current-password" required
                                                        class="block w-full appearance-none border-none px-3 py-2 placeholder-gray-400 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500 sm:text-sm"
                                                        v-model="user.password" />
                                                    <div @click="toggleVisibility('pass')"
                                                        class="h-full self-center border-l-2 px-2 cursor-pointer focus:bg-slate-700">
                                                        <svg v-if="!showPass" aria-hidden="true" fill="none"
                                            ...
                                            <div class="space-y-1">
                                                <label for="repeat-password"
                                                    ...
                                                    <span
                                                        class="block text-sm font-medium text-slate-700 after:ml-0.5 after:text-red-500 after:content-['*']">Repetir
                                                        contraseña</span>
                                                </label>
                                                <div
                                                    class="flex flex-nowrap justify-center align-middle mt-1 border-2 rounded-md">
                                                    <input v-if="!showPassConfirm" id="repeat-password"
                                                        name="repeat-password" type="password" minlength="6"
                                                        @input="validatePassword" autocomplete="current-repeat-password"
                                                        required
                                                        class="block w-full appearance-none border-none px-3 py-2 placeholder-gray-400 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500 sm:text-sm"
                                                        v-model="user.password_confirmation" />
                                                    <input v-else id="repeat-password" name="repeat-password" type="text"
                                                        minlength="6" @input="validatePassword"
                                                        autocomplete="current-repeat-password" required
                                                        class="block w-full appearance-none border-none px-3 py-2 placeholder-gray-400 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500 sm:text-sm"
                                                        v-model="user.password_confirmation" />
                                                    <div @click="toggleVisibility('confirm')"
                                                        class="h-full self-center border-l-2 px-2 cursor-pointer focus:bg-slate-700">
                                                        <svg v-if="!showPassConfirm" aria-hidden="true" fill="none"
                                                            stroke="currentColor" class="w-6 h-6 text-gray-500"
                                                            stroke-width="1.5" viewBox="0 0 24 24"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                            ...
                                            <div class="space-y-1">
                                                <label for="profile_photo_path"
                                                    class="block text-sm font-medium text-gray-700">
                                                    <span
                                                        class="block text-sm font-medium text-slate-700 after:ml-0.5 after:text-red-500 after:content-['*']">Foto
                                                        de perfil</span>
                                                </label>
                                                <div class="flex items-center justify-center space-y-1">
                                                    <input type="file" required id="profile_photo_path"
                                            ...
                                            <div class="mb-6 md:flex md:items-center">
                                                <label class="block text-gray-500">
                                                    <input class="mr-2 leading-tight" type="checkbox" v-model="user.terms"
                                                        required />
                                                    <span
                                                        class="text-xs font-medium text-slate-700 after:ml-0.5 after:text-red-500 after:content-['*']">
                                                        Acepto el
                                            ...
                                            <div class="mb-6 md:flex md:items-center">
                                                <label class="block text-gray-500">
                                                    ...
                                                    <span class="text-xs font-medium text-slate-700">Acepto recibir
                                                        comunicados de mi interés relacionados con EXPERIENTYA.</span>
                                                </label>
                                                <jet-input-error :message="user.errors.newsletter" />
                                            </div>
                                            <div>
                                                <jet-button :disabled="user.processing"
                                                    class="flex w-full justify-center rounded-md border border-transparent bg-blue-500 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">Guardar
                                                    y Continuar</jet-button>
                                            </div>
                        ...
                        <div class="relative hidden w-0 flex-1 lg:block">
                            <img class="absolute inset-0 h-full w-full rounded-r-2xl object-cover"
                    ...
                    <div class="mt-24 mb-16 flex min-h-full rounded-2xl bg-white shadow-md">
                        <div class="flex flex-1 flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-20">
                            <div class="mx-auto w-full lg:w-[35rem]">
                                ...
                                <div class="mt-6">
                                    <label class="mx-auto text-gray-400 text-sm"><span
                                            class="block after:ml-0.5 after:text-red-500 after:content-['*']">Para finalizar
                                            su registro ingrese su datos de contacto. Los campos requeridos son marcados con
                                            un asterisco</span></label>
                                    <div>
                                        <div class="relative mt-1">
                                            <div class="absolute inset-0 flex items-center" aria-hidden="true">
                                                <div class="w-full border-t border-gray-300"></div>
                                        ...
                                        <form @submit.prevent="submit" class="space-y-6">
                                            <div class="-mx-3 mb-2 flex flex-wrap">
                                                <div class="mb-6 w-full px-3 md:mb-0 md:w-1/3">
                                                    <label class="mb-2 block" for="country">
                                                        <span
                                                            class="block text-sm font-medium text-slate-700 after:ml-0.5 after:text-red-500 after:content-['*']">País</span>
                                                    </label>
                                                    <div class="mt-1">
                                                        <select v-model="user.user_country_id" id="state"
                                                ...
                                                <div class="mb-6 w-full px-3 md:mb-0 md:w-1/3">
                                                    <label class="mb-2 block" for="state">
                                                        <span
                                                            class="block text-sm font-medium text-slate-700 after:ml-0.5 after:text-red-500 after:content-['*']">Estado</span>
                                                    </label>
                                                    <div class="mt-1">
                                                        <select v-model="user.user_state_id" required id="state"
                                                            class="mt-1 block w-full rounded-md border-gray-300 py-2 pl-3 pr-10 text-base focus:border-blue-500 focus:outline-none focus:ring-blue-500 sm:text-sm">
                                                ...
                                                <div class="w-full px-3 md:w-1/3">
                                                    <label class="mb-2 block" for="town">
                                                        <span
                                                            class="block text-sm font-medium text-slate-700 after:ml-0.5 after:text-red-500 after:content-['*']">Ciudad
                                                            / Municipio</span>
                                                    </label>
                                                    <div class="mt-1">
                                                        <select v-model="user.user_city_id" id="town" required
                                                            class="mt-1 block w-full rounded-md border-gray-300 py-2 pl-3 pr-10 text-base focus:border-blue-500 focus:outline-none focus:ring-blue-500 sm:text-sm">
                                            ...
                                            <div>
                                                <label for="user_address" class="block text-sm font-medium text-gray-700">
                                                    <span
                                                        class="block text-sm font-medium text-slate-700 after:ml-0.5 after:text-red-500 after:content-['*']">Dirección</span>
                                                </label>
                                                <div class="mt-1">
                                                    <input id="user_address" name="user_address" type="text"
                                                        autocomplete="user_address" required
                                                        class="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500 sm:text-sm"
                                            ...
                                            <div class="-mx-3 mb-6 flex flex-wrap">
                                                <div class="w-full px-3 md:w-1/3">
                                                    <label class="mb-2 block" for="user_postal_code">
                                                        <span
                                                            class="block text-sm font-medium text-slate-700 after:ml-0.5 after:text-red-500 after:content-['*']">Código
                                                            Postal</span>
                                                    </label>
                                                    <div class="mt-1">
                                                        <input id="user_postal_code" name="user_postal_code" type="text"
                                                            min="0"
                                                            oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"
                                                            maxlength="7" autocomplete="postal_code" required
                                                            class="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500 sm:text-sm"
                                                ...
                                                <div class="mb-6 w-full px-3 md:mb-0 md:w-1/3">
                                                    <label class="mb-2 block" for="user_phone_number">
                                                        <span
                                                            class="block text-sm font-medium text-slate-700 after:ml-0.5 after:text-red-500 after:content-['*']">Teléfono
                                                            1</span>
                                                    </label>
                                                    <div class="mt-1">
                                                        <input id="user_phone_number" name="user_phone_number" type="text"
                                                            min="0"
                                                            oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"
                                                            minlength="10" maxlength="10" autocomplete="user_phone_number"
                                                            required
                                                            class="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500 sm:text-sm"
                                                ...
                                                <div class="w-full px-3 md:w-1/3">
                                                    <label class="mb-2 block" for="user_second_phone_number">
                                                        <span class="block text-sm font-medium text-slate-700">Teléfono
                                                            2</span>
                                                    </label>
                                                    <div class="mt-1">
                                                        <input id="user_second_phone_number" name="user_second_phone_number"
                                                            oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"
                                                            type="text" min="0" minlength="10" maxlength="10"
                                            ...
                                            <div>
                                                <label for="email_alternative"
                                                    class="block text-sm font-medium text-gray-700">
                                                    <span
                                                        class="block text-sm font-medium text-slate-700 after:ml-0.5 after:text-red-500 after:content-['*']">Correo
                                                        electrónico alternativo</span>
                                                </label>
                                                <div class="mt-1">
                                                    <input id="email_alternative" name="email_alternative" type="email"
                                                        autocomplete="email" required @blur="validateAlternativeEmail"
                                                        class="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500 sm:text-sm"
                                            ...
                                            <div>
                                                <label for="user_date_of_birth"
                                                    class="block text-sm font-medium text-gray-700">
                                                    <span
                                                        class="block text-sm font-medium text-slate-700 after:ml-0.5 after:text-red-500 after:content-['*']">Fecha
                                                        de nacimiento</span>
                                                </label>
                                                <input type="date" name="user_date_of_birth" id="user_date_of_birth"
                                                    required
                                                    class="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500 sm:text-sm"
                                            ...
                                            <div class="flex content-around justify-around">
                                                ...
                                                <jet-button :disabled="user.processing"
                                                    class="flex w-1/2 justify-center rounded-md border border-transparent bg-blue-500 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">Guardar
                                                    y Continuar</jet-button>
                                            </div>
                                        </form>
                                    </div>
                        ...
                        <div class="relative hidden w-0 flex-1 lg:block">
                            <img class="absolute inset-0 h-full w-full rounded-r-2xl object-cover"
                                src="https://pbs.twimg.com/media/EYid9iWWsAAaMGX?format=jpg&name=4096x4096" alt />
                        </div>
                    </div>
                </div>
            </Transition>
