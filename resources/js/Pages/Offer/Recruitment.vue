            ...
            <div
                ...
                <div
                    ...
                    <div class="flex items-center align-middle justify-center">
                        <div class="rounded-lg bg-blue-500 text-white h-fit p-4 m-2 lg:my-0 max-w-[150px] text-center">
                            <div class="hidden lg:pb-3 lg:block text-base lg:text-xl font-semibold">Solicitudes</div>
                            <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"
                                class="w-10 h-10 text-center mx-auto" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        ...
                        <div
                            class="rounded-lg border border-blue-500 p-2 m-1 lg:p-4 lg:m-2 max-w-[150px] text-center bg-white">
                            <div class="text-xs font-normal lg:text-base lg:font-medium leading-none lg:leading-none pb-2">
                                Solicitudes Enviadas</div>
                            <div class="text-base font-bold lg:text-3xl">{{ sent }}</div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="text-base font-bold lg:text-3xl">{{ receipt }}</div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="text-base font-bold lg:text-3xl">{{ approved }}</div>
                        </div>
                    </div>
...
export default {
    ...
    computed: {
        ...
        approved() {
            const approvedRequests = this.Invites.filter(invite => invite.status === 'approved')
