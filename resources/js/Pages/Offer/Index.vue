                    ...
                    <div class="py-4 mt-2">
                        <div class="sm:flex sm:items-center">
                            ...
                            <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                                <Link v-if="total_spaces > 0" :href="route('offer.create')" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-teal-600 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500">
...
<script>
    ...
    export default defineComponent({
        ...
        created () {
            this.$page.props.auth.company.total_spaces_available.forEach(element => {
                this.total_spaces = this.total_spaces + element.spaces_available
            });
        }
    })
</script>
