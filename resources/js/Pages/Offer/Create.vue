                ...
                <div class="bg-white shadow sm:rounded-lg">
                    ...
                    <div class="border-t border-gray-200 px-4 py-5 sm:px-6 mb-4">
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-12 lg:col-span-6 mt-1">
                                <label for="profile_description" class="block text-sm font-medium text-gray-700 after:text-red-500 after:content-['*']">Pérfil de Cadidato ideal</label>
                                <textarea
                            ...
                            <div class="col-span-12 lg:col-span-2 mt-1">
                                ...
                                <select v-model="form.anuies_area_id" id="town" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-teal-500 focus:border-teal-500 sm:text-sm rounded-md">
                            ...
                            <div class="col-span-12 lg:col-span-2 mt-1">
                                ...
                                <select v-model="form.anuies_general_id" id="town" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-teal-500 focus:border-teal-500 sm:text-sm rounded-md">
                            ...
                            <div class="col-span-12 lg:col-span-2 mt-1">
                                ...
                                <select v-model="form.anuies_specific_id" id="town" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-teal-500 focus:border-teal-500 sm:text-sm rounded-md">
...
<script>
    ...
    export default defineComponent({
        ...
        watch: {
            ...
            'form.anuies_area_id': function(value) {
            ...
            'form.anuies_general_id': function(value) {
