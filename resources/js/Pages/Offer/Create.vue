                ...
                <form aria-labelledby="applicant-information-title" @submit.prevent="submit">
                    <div class="bg-white shadow sm:rounded-lg">
                        ...
                        <div class="flex justify-end px-4 py-4 bg-gray-100 rounded-b-md">
                            <button v-show="!form.question_check" class="px-5 py-3 w-full lg:w-auto mr-2 bg-red-500 justify-center rounded-xl text-sm" :disabled="form.processing">
                                <span class="text-white">
                                    Cancelar
                                </span>
                            </button>
                            <button v-show="!form.question_check" class="px-5 py-3 w-full lg:w-auto bg-teal-400 justify-center rounded-xl text-sm" :disabled="form.processing">
