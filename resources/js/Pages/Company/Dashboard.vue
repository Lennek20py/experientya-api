<template>
    <admin-layout :viewSelect="'navHome'">
        <main class="flex-1 pb-8">
            <input v-model="useridchat" class="rounded-full p-2 px-4 ml-6 mt-4" type="number" name="" id="">
            <button class="rounded-full bg-lime-500 p-2 px-4 ml-6 mt-4" @click="chatStuden">
                Chat con user id {{ useridchat }}
            </button>

            <button class="rounded-full bg-teal-500 p-2 px-4 ml-6 mt-4" @click="chats()">
                Chats
            </button>
                ...
                <div class="max-w-7xl px-4 sm:px-6 md:px-8">
                    <form class="flex items-center" @submit.prevent="submit">
                        ...
                        <div class="relative w-full">
                            <input v-model="form.search" type="text" id="simple-search"
            ...
            <JetModal maxWidth="4xl" :show="acting" @close="acting = null">
                ...
                <div class="bg-white shadow sm:rounded-lg">
                    <form class="px-4 py-5 sm:p-6">
                        <h3 class="mb-6 text-2xl leading-6 font-bold text-gray-900">
                            Filtros
                        </h3>
                        <div class="mt-2 text-sm text-gray-500">
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-12 lg:col-span-2 mt-1">
                                    ...
                                    <select v-model="form.area_id" id="town"
                                        class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-purple-500 focus:border-purple-500 sm:text-sm rounded-md">
                                        <option value="">
                                            Seleccione un area
                                        </option>
                                        <option v-for="area in anuies_area" :key="area.id" :value="area.id">
                                            {{ area.name }}
                                        </option>
                                    </select>
                                </div>
                                <div class="col-span-12 lg:col-span-2 mt-1">
                                    <label for="type_of_contract" class="block text-sm font-medium text-gray-700">Area
                                        general</label>
                                    <select v-model="form.general_id" id="town"
                                        class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-purple-500 focus:border-purple-500 sm:text-sm rounded-md">
                                        <option value="">
                                            Seleccione un area general
                                        </option>
                                        <option v-for="general in anuies_general" :key="general.id" :value="general.id">
                                            {{ general.name }}
                                        </option>
                                    </select>
                                </div>
                                <div class="col-span-12 lg:col-span-2 mt-1">
                                    <label for="type_of_contract" class="block text-sm font-medium text-gray-700">Area
                                        específica</label>
                                    <select v-model="form.specific_id" id="town"
                                        class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-purple-500 focus:border-purple-500 sm:text-sm rounded-md">
                                        <option value="">
                                            Seleccione un area específica
                                        </option>
                                        <option v-for="specific in anuies_specific" :key="specific.id" :value="specific.id">
                                            {{ specific.name }}
                                        </option>
                                    </select>
                                </div>
                        ...
                        <div class="mt-7 text-sm text-gray-500">
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-12 lg:col-span-3 mt-1">
                                    <label for="type_of_contract" class="block text-sm font-medium text-gray-700">Ciudad o
                                        Municipio</label>
                                    <select v-model="form.town_id" id="town"
                                        class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-purple-500 focus:border-purple-500 sm:text-sm rounded-md">
                                        <option value="">
                        ...
                        <div class="mt-7 text-sm text-gray-500">
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-12 lg:col-span-4 mt-1">
                                    <label for="type_job" class="block text-sm font-medium text-gray-700 mb-3">Tipo de
                                        Trabajo</label>
                                    <div class="flex">
                                        <div class="flex items-center mr-4">
                                            <input id="inline-checkbox" type="checkbox" v-model="form.work" true-value="1"
                                                :false-value="null"
                                            ...
                                            <label for="inline-checkbox"
                                                class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Empleo</label>
                                        </div>
                                        <div class="flex items-center mr-4">
                                            <input id="inline-2-checkbox" type="checkbox" v-model="form.practices"
                                                true-value="1" :false-value="null"
                                                class="w-4 h-4 text-purple-600 bg-gray-100 rounded border-gray-300 focus:ring-purple-500 dark:focus:ring-purple-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                            <label for="inline-2-checkbox"
                                                class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Residencia
                                                / Práctica
                                                profesional</label>
                                        </div>
                                        <div class="flex items-center mr-4">
                                            <input checked id="inline-checked-checkbox" type="checkbox"
                                                v-model="form.dual_education" true-value="1" :false-value="null"
                                                class="w-4 h-4 text-purple-600 bg-gray-100 rounded border-gray-300 focus:ring-purple-500 dark:focus:ring-purple-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                            <label for="inline-checked-checkbox"
                                                class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Educación
                                                Dual</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-span-12 lg:col-span-2 mt-1">
                                    <label for="range" class="block text-sm font-medium text-gray-700 mb-3">Cambio de
                                        residencia</label>
                                    <div class="space-y-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-10">
                                        <div class="flex items-center">
                                            <input v-model="form.change_address" id="payment_type_1" type="radio" value="Y"
                                        ...
                                        <div class="flex items-center">
                                            <input v-model="form.change_address" id="payment_type_2" type="radio" value="N"
                                                class="focus:ring-purple-500 h-4 w-4 text-purple-600 border-gray-300" />
                                ...
                                <div class="col-span-12 lg:col-span-2 mt-1">
                                    <label for="range" class="block text-sm font-medium text-gray-700 mb-3">¿Que cuente con
                                        experiencia?</label>
                                    <div class="space-y-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-10">
                                        <div class="flex items-center">
                                            <input v-model="form.experiences" id="experience_1" type="radio" value="Y"
                                                class="focus:ring-purple-500 h-4 w-4 text-purple-600 border-gray-300" />
                                            <label for="experience_1" class="ml-3 block text-sm font-medium text-gray-700">
                                                Si
                                            </label>
                                        </div>

                                        <div class="flex items-center">
                                            <input v-model="form.experiences" id="experience_2" type="radio" value="N"
                                                class="focus:ring-purple-500 h-4 w-4 text-purple-600 border-gray-300" />
                                            <label for="experience_2" class="ml-3 block text-sm font-medium text-gray-700">
                                                No
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="col-span-12 lg:col-span-2 mt-1">
                                    ...
                                    <div class="space-y-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-10">
                                        <div class="flex items-center">
                                            <input v-model="form.certifications" id="certifications_1" type="radio"
                                                value="Y"
                                                class="focus:ring-purple-500 h-4 w-4 text-purple-600 border-gray-300" />
                                            <label for="certifications_1"
                                                class="ml-3 block text-sm font-medium text-gray-700">
                                                Si
                                            </label>
                                        </div>
                                        ...
                                        <div class="flex items-center">
                                            <input v-model="form.certifications" id="certifications_2" type="radio"
                                                value="N"
                                                class="focus:ring-purple-500 h-4 w-4 text-purple-600 border-gray-300" />
                                            <label for="certifications_2"
                                                class="ml-3 block text-sm font-medium text-gray-700">
                                                No
                                            </label>
                                        </div>
                                ...
                                <div class="col-span-12 lg:col-span-2 mt-1">
                                    <label for="range" class="block text-sm font-medium text-gray-700 mb-3">¿Que hable otro
                                        idioma?</label>
                                    <div class="space-y-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-10">
                                        <div class="flex items-center">
                                            <input v-model="form.lenguages" id="lenguages_1" type="radio" value="Y"
                                                class="focus:ring-purple-500 h-4 w-4 text-purple-600 border-gray-300" />
                                            <label for="lenguages_1" class="ml-3 block text-sm font-medium text-gray-700">
                                                Si
                                            </label>
                                        </div>

                                        <div class="flex items-center">
                                            <input v-model="form.lenguages" id="lenguages_2" type="radio" value="N"
                                                class="focus:ring-purple-500 h-4 w-4 text-purple-600 border-gray-300" />
                                            <label for="lenguages_2" class="ml-3 block text-sm font-medium text-gray-700">
                                                No
                                            </label>
                                        </div>
                                    </div>
                        ...
                        <div class="flex justify-end mt-5">
                            ...
                            <button type="button" @click="clear()"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                    stroke="currentColor" class="-ml-0.5 mr-2 h-4 w-4 text-white">
                                    <path stroke-linecap="round" stroke-linejoin="round"
