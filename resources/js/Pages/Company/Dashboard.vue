            ...
            <div class="py-6">
                <div class="max-w-7xl px-4 sm:px-6 md:px-8">
                    <form class="flex items-center" @submit.prevent="submit">
                        <button  @click="acting = true" type="button" class="mr-2 inline-flex items-center rounded-md border border-transparent bg-purple-500 px-3 py-3 text-sm font-medium leading-4 text-white shadow-sm hover:bg-purple-600 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2">
                        ...
                        <div class="relative w-full">
                            <input v-model="form.search" type="text" id="simple-search" class="bg-slate-50-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-500 dark:focus:border-purple-500" placeholder="">
                        </div>
                        <button  type="submit" class="ml-2 inline-flex items-center rounded-md border border-transparent bg-blue-500 px-3 py-3 text-sm font-medium leading-4 text-white shadow-sm hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                            <!-- Heroicon name: mini/envelope -->
                            <svg aria-hidden="true" class="-ml-0.5 mr-2 h-4 w-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd"></path></svg>
                            Buscar
                        </button>
                    </form>
