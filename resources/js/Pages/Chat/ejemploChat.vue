      ...
      <section class="msger">
        ...
        <div class="msger-inputarea">
          <input
            ...
            placeholder="Enter your message..."
          />
          <button type="submit" class="msger-send-btn" @click="buttonSumit">
            Send
          </button>
        </div>
      </section>
  ...
  await axios
    ...
    .then((res) => {
      ...
      appendMessage(
        ...
        data.user.profile_photo_path.replace("profile/", "storage/profile/"),
        "right",
        data.content,
