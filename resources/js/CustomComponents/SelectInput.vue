<template>
    <Listbox as="div" v-model="selected">
        <ListboxLabel class="block text-sm font-medium text-gray-700">Tipo de Horario</ListboxLabel>
            ...
            <ListboxButton
                ...
                <span class="pointer-events-none absolute inset-y-0 right-0 ml-3 flex items-center pr-2">
                    <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"
                        class="text-gray-400 h-5 w-5" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    ...
                    <ListboxOption as="template" v-for="person in people" :key="person.id" :value="person"
                        ...
                        <li
                            ...
                            <span v-if="selected"
                                ...
                                <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"
                                    class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
