<template>
    <div v-if="message || showNotification" id="toast-success" class="flex items-center py-2 px-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow" role="alert">
    ...
    <div class="ml-3 text-sm font-normal select-none">{{$page.props.flash.message}}</div>
