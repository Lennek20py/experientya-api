                            ...
                            <DialogPanel
                                ...
                                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                    <div class="sm:flex sm:items-start">
                                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                            <DialogTitle as="h3" class="text-lg font-medium leading-6 text-gray-900">Filtros
                                                de
                                            ...
                                            <SelectInput :CustomData="horaryData" :Title="'Tipo de Horario'"
                                                v-model="filter.time_work" />
                                            <SelectInput :CustomData="workData" :Title="'Tipo de Trabajo'"
                                                v-model="filter.type_work" />
                                            <SelectInput :CustomData="contractData" :Title="'Tipo de Contrato'"
                                                v-model="filter.type_contract" />
                                            <SelectInput :CustomData="paymentPeriod" :Title="'Periodo de Pago'"
                                ...
                                <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                    <button type="button"
                                        ...
                                        @click="emit('setOpen', !props.open); emit('update:modelValue', filter)">Aplicar</button>
                                    <button type="button"
...
const emit = defineEmits(['setOpen', 'update:modelValue'])
