                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="esd-block-text es-p20t es-p20b es-p5r es-p5l" align="left">
                                                                                            <p style="color: #cc0000; font-family: georgia, times, 'times new roman', serif;"><span style="color:#000000;"><b>Estimado(a)</b></span><b><strong></strong></b><span style="color:#FF0000;"><u><strong>{{ $mailData['title'] }}</strong></u></span></p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="esd-block-text es-p10t es-p5r es-p5l">
                                                                                            <p style="font-size: 14px; color: #ff0000; font-family: georgia, times, 'times new roman', serif; line-height: 120%; text-align: justify;">De acuerdo a la revisión de su perfil por parte de la empresa usted ha sido seleccionado a participar en el proceso de reclutamiento para el puesto de&nbsp;<u><strong><span style="font-size:16px;"> Empleo Ejemplo</span></strong></u>&nbsp; haga click en el enlace para revisar la vacante.</p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                    ...
                                                                    <tr>
                                                                        <td class="esd-container-frame" width="560" align="left">
                                                                            <table width="100%" cellspacing="10" cellpadding="0">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="esd-block-button es-p10t es-p10b es-m-txt-l" align="center"><button type="button" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
