        ...
        <div class="resume-wrapper-inner mx-auto text-start bg-white shadow-lg">
                    ...
                    <div class="col">
                        <div class="row p-4 justify-content-center justify-content-md-between">
                            <div class="primary-info col-auto">
                                <h1 class="name mt-0 mb-1 text-white text-uppercase text-uppercase">{{ $user->user_first_name }} {{ $user->user_last_name }}</h1>
                                <div class="title mb-3">{{$user->position}}</div>
                                <ul class="list-unstyled">
                                    <li class="mb-2"><a class="text-link" href="#"><i class="far fa-envelope fa-fw me-2" data-fa-transform="grow-3"></i>Email: {{$user->email}}</a></li>
                                    <li><a class="text-link" href="#"><i class="fas fa-mobile-alt fa-fw me-2" data-fa-transform="grow-6"></i>Teléfono: {{ $user->user_phone_number }}</a></li>
                                    <li><a class="text-link" href="#"><i class="fas fa-mobile-alt fa-fw me-2" data-fa-transform="grow-6"></i>Ubicación: {{$user->city_name}}, {{$user->state_name}}</a></li>
                                </ul>
                            </div><!--//primary-info-->
            ...
            <div class="resume-body p-5">
                <section class="resume-section summary-section mb-5">
                    <h2 class="resume-section-title text-uppercase font-weight-bold pb-3 mb-3">Preferencias Laborales</h2>
                    <div class="resume-section-content">
                        <p class="mb-0">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title mb-2">Campos Laborales</h5>
                                    <p class="card-text"> <strong>Área: </strong> {{ $user->area_name }}</p>
                                    <p class="card-text"> <strong>Campo General: </strong> {{ $user->general_area_name }}</p>
                                    <p class="card-text"> <strong>Campo Específico: </strong> {{ $user->specific_area_name }}</p>
                                </div>
                            </div>

                            <div class="card mt-4">
                                <div class="card-body">
                                    <h5 class="card-title mb-2">Me Interesa</h5>
                                    @if ($user->work == '1')
                                        <p class="card-text">Trabajo</p>
                                    @endif
                                    @if ($user->practices == '1')
                                        <p class="card-text">Residencia / Práctica profesional</p>
                                    @endif
                                    @if ($user->dual_education == '1')
                                        <p class="card-text">Educación dual</p>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="card mt-4">
                                <div class="card-body">
                                    <h5 class="card-title mb-2">Cambio de Residencia</h5>
                                    @if ($user->change_city == 'Y')
                                        <p class="card-text">Sí</p>
                                    @elseif ($user->change_city == 'N')
                ...
                <div class="row">
                    <div class="col-lg-9">
                        <section class="resume-section experience-section mb-5">
                            <h2 class="resume-section-title text-uppercase font-weight-bold pb-3 mt-3 mb-3">Experiencia Laboral</h2>
                            <div class="resume-section-content">
                                    ...
                                    <article class="resume-timeline-item position-relative pb-5">
                                        ...
                                        <div class="resume-timeline-item-header mb-2">
                                            <div class="d-flex flex-column flex-md-row">
                                                <h3 class="resume-position-title font-weight-bold mb-1">{{ $experience->company }}</h3>
                                                <div class="resume-company-name ms-auto">
                                                    {{ $experience->city }}, {{ $experience->state }}, {{ $experience->country}}
                                                </div>
                                            </div><!--//row-->
                                            <div class="resume-position-time mb-2">{{ $experience->start_date }} - {{ $experience->end_date }}</div>
                    ...
                    <div class="col-lg-3">
                        <section class="resume-section skills-section mb-4">
                            <h2 class="resume-section-title text-uppercase font-weight-bold pb-3 mb-1">Skills &amp; Herramientas</h2>
                            <div class="resume-section-content">
                                <div class="resume-skill-item">

                                    <ul class="list-unstyled mb-1">
                                        @foreach ($user->userSkills as $user_skill)
                                        <li class="mb-2">
                                            <div class="resume-skill-name">{{ $user_skill->skill }}</div>
                                        </li>
                                        @endforeach
                                    </ul>
                        ...
                        <section class="resume-section education-section mb-5">
                            ...
                            <div class="resume-section-content">
                                <ul class="list-unstyled">
                                    @foreach ($user->studyDegrees as $study)
                                    <li class="mb-2">
                                        <div class="resume-degree font-weight-bold">{{ $study->study_level }} en {{ $study->study_tittle }}</div>
                                        <div class="resume-degree-org">{{ $study->school_name }}</div>
                                        <div class="resume-degree-time">{{$study->starting_year }} - {{ $study->finished_year }}</div>
                                    </li>
                                    @endforeach
                                </ul>
                            </div>
                        ...
                        <!--//education-section-->
                        <section class="resume-section language-section mb-3">
                            <h2 class="resume-section-title text-uppercase font-weight-bold pb-3 mb-1">Certificaciones</h2>
                            <div class="resume-section-content">
                                <ul class="list-unstyled resume-lang-list">
                                    @foreach ($user->certifications as $certification)
                                    <li class="mb-2">
                                        <span class="resume-lang-name font-weight-bold">{{ $certification->name_certification }} </span>
                                    </li>
                                    @endforeach
                                </ul>
                            </div>
                        ...
                        <!--//interests-section-->
                        <section class="resume-section language-section mb-3">
                            <h2 class="resume-section-title text-uppercase font-weight-bold pb-3 mb-1">Idiomas</h2>
                            <div class="resume-section-content">
                                <ul class="list-unstyled resume-lang-list">
                                    @foreach ($user->lenguages as $language)
                                    <li class="mb-2">
                                        <span class="resume-lang-name font-weight-bold">{{ $language->name_language }} </span>
